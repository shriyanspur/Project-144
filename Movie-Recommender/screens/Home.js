...
export default class HomeScreen extends Component {
  ...
  unlikedMovie = () => {
    const url = 'http://localhost:5000/disliked-movies';
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = 'http://localhost:5000/not_watched-movies';
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
  ...
  render() {
    ...
    if (movieDetails.poster_link) {
      const {original_title, imdb_link, release_date, runtime, vote_average} = movieDetails;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.subContainer}>
            <View style={styles.subTopContainer}>
              <Image style={styles.posterImage} source={{ uri: imdb_link }} />
            </View>
